...
const playCta =
  'flex cursor-pointer items-center justify-center gap-3 rounded-panel border-0 bg-landing-accent font-bold text-landing-accent-ink transition-[color,background-color,border-color,scale] duration-150 ease-out hover:bg-landing-accent/90 focus-visible:outline-3 focus-visible:outline-focus focus-visible:outline-offset-3 active:scale-[0.97]'
