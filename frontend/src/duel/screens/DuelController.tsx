  ...
  return (
    <ControllerScreen className="bg-duel-canvas">
      ...
      <section className="mt-3 grid flex-none gap-2 text-center">
        ...
        {permission === 'unknown' && (
          <button
            className="min-h-12 rounded-card border border-duel-signal/50 bg-duel-signal/15 px-5 font-bold text-duel-accent-soft transition-[scale] duration-150 focus-ring pressable"
