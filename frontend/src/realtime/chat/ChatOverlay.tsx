...
/**
 * 펼침용 — 대화를 **읽는** 자리라 접힘보다 진하다. 옅으면 뒤 안내 카드나 점수가 글자 사이로
 * 비쳐 둘 다 못 읽는다.
 *
 ...
 */
const OPEN_BACKDROP =
  '-mx-3 px-3 pt-3 pb-14 bg-[linear-gradient(to_bottom,rgb(0_0_0/_0%)_0%,rgb(0_0_0/_92%)_10%,rgb(0_0_0/_85%)_64%,rgb(0_0_0/_0%)_100%)]'
