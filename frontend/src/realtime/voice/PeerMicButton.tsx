...
export function PeerMicButton({ className, playerId, voice }: PeerMicButtonProps) {
  ...
  return (
    <button
      ...
      aria-pressed={muted}
      className={cn(
        'relative grid size-6 flex-none cursor-pointer place-items-center rounded-full border-0 bg-transparent p-0 text-[13px] leading-none transition-opacity focus-visible:outline-2 focus-visible:outline-focus',
