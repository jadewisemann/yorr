  ...
  return (
    <>
      ...
      <main className="relative mx-auto flex h-svh w-full max-w-2xl flex-col overflow-x-hidden px-gutter pt-6 pb-[max(1.875rem,env(safe-area-inset-bottom))] text-content">
        ...
        <span className="relative inline-flex w-fit items-center gap-2 rounded-full border border-border bg-white/6 px-3 py-1.5 font-mono text-2xs font-bold tracking-[0.16em] text-content-muted uppercase">
        ...
        <section className="relative mt-5 flex items-center justify-between gap-4 rounded-panel border border-white/18 bg-surface-raised p-4.5">
