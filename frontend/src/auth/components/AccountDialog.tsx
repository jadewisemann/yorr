...
// 알리는 유일한 채널이라, 여기 여섯 행이 그것만 빠져 있었다.
const row =
  'flex w-full items-center gap-3 rounded-card border border-border bg-surface px-4 py-3.5 text-left text-sm font-semibold text-content transition-[color,background-color,border-color,scale] duration-150 ease-out focus-visible:outline-3 focus-visible:outline-landing-accent focus-visible:outline-offset-2 active:not-disabled:scale-[0.97]'
