...
/**
 * 서버가 소켓을 닫을 때 쓰는 유일한 close code(policy violation).
 * 하트비트 타임아웃과 소켓 교체 두 경우뿐이다.
 */
export const WS_CLOSE_POLICY_VIOLATION = 1008

/**
 * 인바운드 메시지 크기 상한. `ws`의 기본값은 100MB라 그대로 두면 소켓 하나가
...
/**
 * `error` 봉투의 code — 이 문자열이 그대로 와이어에 실린다.
