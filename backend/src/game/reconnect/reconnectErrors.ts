...
export type ReconnectSnapshotReason =
   ...
   * 실제로 도달한다(docs/design/reconnect.md 「알려진 틈」 — 계약 동결로 유지).
   */
  | 'DEADLINE_NOT_FOUND'
 ...
 * (`RoundSynchronizationError`가 같은 이유로 분리돼 있다).
 */
